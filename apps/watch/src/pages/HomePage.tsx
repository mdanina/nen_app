...
export function HomePage({ titles, favorites, toggleFavorite, navigate }: { titles: WatchTitle[]; favorites: string[]; toggleFavorite: (id: string) => void; navigate: Navigate }) {
  return <div className="page home-page">
    <section className="hero">
      ...
      <p className="lead">Подберите фильм или мультфильм для совместного просмотра — по возрасту ребёнка, интересам и настроению. А после можно обсудить то, что оказалось важным.</p>
    </section>
